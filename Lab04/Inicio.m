...
- (void)initController {
    maIntroTitles   = [[NSMutableArray alloc] initWithObjects: @"Porque tu lo pediste", @"Conoce a los caballeros", @"Directamente desde tu iPhone", nil];
    
    maIntroImages   = [[NSMutableArray alloc] initWithObjects: @"Atenas.png", @"Caballeros.png", @"Fenix.png", nil];
